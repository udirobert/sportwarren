                        ...
                        <div className="p-4 bg-gradient-to-r from-gray-900 to-black border-b border-white/5 flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <div className="relative">
                                    ...
                                    <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 rounded-full flex items-center justify-center border-2 border-gray-900 shadow-lg" title="Verified Identity">
                                        <ShieldCheck className="w-2.5 h-2.5 text-white" />
                                    </div>
                                </div>
                                <div>
                                    <div className="flex items-center gap-1.5 leading-none mb-1">
                                        <div className="text-[10px] font-black text-blue-400 uppercase tracking-widest">Verified Agent</div>
                                    ...
                                    <h3 className="text-sm font-black text-white uppercase italic tracking-tight flex items-center gap-2">
                                        Marcus
                                        <span className="px-1 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[8px] font-black text-emerald-400 uppercase tracking-widest">Active</span>
                                    </h3>
                                </div>
                            </div>
                            <button
