...
export default {
  ...
  theme: {
    ...
    // Centralized semantic tokens for consistency
    // ─────────────────────────────────────────────────────────
    extend: {
      ...
      // Design token CSS variables - defined in globals.css for DRY compliance
      // Tokens are referenced via hsl(var(--token)) in component classes
