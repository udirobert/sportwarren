...
export interface SquadTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface SquadToken extends BaseContract {
  connect(runner?: ContractRunner | null): SquadToken;
  waitForDeployment(): Promise<this>;

  interface: SquadTokenInterface;
