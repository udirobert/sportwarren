...
export interface SquadGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface SquadGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): SquadGovernor;
  waitForDeployment(): Promise<this>;

  interface: SquadGovernorInterface;
  ...
  initialize: TypedContractMethod<
    [_token: AddressLike, _timelock: AddressLike, defaultAdmin: AddressLike],
    [void],
    "nonpayable"
  >;
