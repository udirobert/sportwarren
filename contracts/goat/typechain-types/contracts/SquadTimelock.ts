...
export interface SquadTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface SquadTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): SquadTimelock;
  waitForDeployment(): Promise<this>;

  interface: SquadTimelockInterface;
